...
class _document_MyDocument extends document_default.a {
  ...
  render() {
    return __jsx(next_document["Html"], null, __jsx("link", {
      href: "https://fonts.googleapis.com/css2?family=Exo:ital@1&display=swap",
      rel: "stylesheet"
    }), __jsx(next_document["Head"], null), __jsx("body", null, __jsx(next_document["Main"], null), __jsx(next_document["NextScript"], null)));
  }
